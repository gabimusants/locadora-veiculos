...
public class ReservaFisView extends JFrame {
	...
	private JComboBox<IPessoaFisica> comboBoxCliente;
	...
	public ReservaFisView() {
		...
		JLabel lblCliente = new JLabel("Cliente Fisico");
		...
		comboBoxCliente = new JComboBox<IPessoaFisica>(clienteController.getDefaultComboBoxModel());
	...
	protected void actionReservar() {
		...
		cliente = (IPessoaFisica) comboBoxCliente.getSelectedItem();
