...
public class TipoReservaView extends JFrame {
	...
	public TipoReservaView() {
		...
		lblReserva.setFont(new Font("Arial", Font.BOLD, 16));
		lblReserva.setBounds(185, 40, 94, 25);
		contentPane.add(lblReserva);
	}
	
	private void actionClienteFisView() {
		ReservaFisView reservaFisView = new ReservaFisView();
		reservaFisView.setVisible(true);
	}
	
	private void actionClienteJurView() {
		ReservaJurView reservaJurView = new ReservaJurView();
		reservaJurView.setVisible(true);
	}
}
